...
| **Decision quality** | A structured multi-dimension framework for evaluating consequential decisions before you commit to them | [`features/decision-quality.md`](features/decision-quality.md) |
